...
public class ConsultaDeAlumnosXMateria extends javax.swing.JInternalFrame {
    ...
    private void cargarMaterias() {
        ...
        for (Materia X : materia.listarMateria()) {
    ...
    private void cargarAlumnos(Materia materia) {
        ...
        List<Alumno> cursantes = inscData.obtenerAlumnosPorMateria(materia.getIdMateria());

        for (Alumno X : cursantes) {

            modelo.addRow(new Object[]{X.getIdAlumno(), X.getDni(), X.getApellido(), X.getNombre()});
        }
        cursantes.clear();
    }

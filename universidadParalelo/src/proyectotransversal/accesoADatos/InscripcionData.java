...
//    }
    ...
    public List<Materia> obtenerMateriasNoCursadas(int idAlumno){
        ...
        ArrayList<Materia> inscripciones= new ArrayList<>();
         ...
         String sql="SELECT * FROM materia WHERE materia.idMateria NOT IN (SELECT materia.idMateria from materia,inscripcion where materia.idMateria = inscripcion.IdMateria AND inscripcion.idAlumno = ?);";
